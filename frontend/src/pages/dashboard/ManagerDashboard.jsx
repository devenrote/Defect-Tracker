                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 text-xs font-semibold">
                        <p className="text-slate-707 dark:text-slate-355 leading-normal">
                          ...
                          <span className="text-slate-500 dark:text-slate-455 font-medium">{act.action}</span>{' '}
                      ...
                      >
                        <div className="min-w-0 flex-1 mr-2">
                          <div className="flex items-center gap-1.5">
                            ...
                            <p className="text-xs font-semibold text-slate-805 dark:text-slate-200 truncate">{item.title}</p>
                          </div>
